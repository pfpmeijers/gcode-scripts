...
def create_arc_pocket(xb1: float, xe1: float, yb1: float, ye1: float, r1: float, clockwise1: bool,
    ...
    xb1, xe1, yb1, ye1, xc1, yc1, r1 = preprocess_arc(xb1, xe1, yb1, ye1, zb, zt, r1, clockwise1, shift)
    xb2, xe2, yb2, ye2, xc2, yc2, r2 = preprocess_arc(xb2, xe2, yb2, ye2, zb, zt, r2, clockwise2, shift)
